export default function Card({ image, heading, para, url }: any) {
    return (
        <>
            <div className="max-w-sm mx-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img className="rounded-t-lg aspect-square object-cover"  src={image}  alt="" />
                </a>
                <div className="p-5">
                    <a href="#">
