...
export default function App() {
  ...
  <h1 className="text-violet-500 mb-7">Scale your publication</h1>
  <h1 className="text-black mb-7">with eVC</h1>
  <h3 className="text-gray-500 text-lg font-light mb-7">
    We are increasing business success with technology
  </h3>
  <Link href="/about" className="flex justify-center items-start">
    <button
      type="button"
        ...
        <div className="flex flex-wrap  gap-20 justify-center items-center px-4 lg:px-0">
          ...
          <div className="lg:ml-8 mt-8 lg:mt-0 w-full lg:w-1/2">
            ...
            <p className="py-6 text-balance">
              Today’s content marketplace has no dearth of fancy solutions.
              Excessive showcase of efficiencies drawn from ideal-case scenarios
              morphed with technological jargon is common in most. However, the
              reality is always different. We understand from our interactions
              with clients that they require solutions that can complement and
              add value to their processes and products rather than doing what
              an off-the-shelf solution usually offers. This is the gap we, at
              eVC-Tech, aspire to bridge.
              <br></br>
              <br></br>
              Customization is at the core of our services. We do not push
              run-of-the-mill solutions but instead try to understand each
              client’s specific requirements in view of their evolving markets
              and business models.
              <br></br>
              <br></br>
              We work with open minds and design our processes and services to
              best-suit our clients’ objectives. We further supplement the
              solutions with cutting-edge tools and the rich knowledge base of
              our subject-matter experts (SMEs), which helps us not only deliver
              quality products on time but also enhance the overall value of the
              products.
              <br></br>
              <br></br>
              Our team has extensive experience in delivering the highest level
              of quality across a range of services, such as:
            </p>
            <ul className="space-y-4">
              ...
              <li className="flex items-start space-x-4">
                ...
                <span className="text-lg text-gray-700">
                  All levels of copyediting and proofreading
                </span>
              </li>
              <li className="flex items-start space-x-4">
                <svg
                ...
                <span className="text-lg text-gray-700">
                  Production services for multi-channel delivery of books and
                  journals, magazines and ads
                </span>
              </li>
              <li className="flex items-start space-x-4">
                <svg
              ...
              <li className="flex items-start space-x-4">
                ...
                <span className="text-lg text-gray-700">
                  Web apps development for business solutions
                </span>
              </li>
            </ul>
          </div>
      ...
      <div className=" flex items-center justify-center px-4 lg:px-0">
        <div className="flex flex-col-reverse lg:flex-row items-center lg:items-start gap-10 lg:gap-20 justify-center mx-auto lg:mx-52">
          <div className="w-full lg:w-1/2  lg:mt-0">
            ...
            <p className="py-6 text-balance">
              We, at eVC-Tech, believe in innovation and live on cutting-edge
              technologies. At the same time, we remain sensitive to the need to
              make the various technologies work for our clients’ needs rather
              than tweaking them to come up with a templated solution.
              <br />
              <br />
              Our motto is “To keep client experience at the center of
              everything that we do.” We measure our strength and success in our
              people’s and customers’ satisfaction and success. And this has
              been possible because of our persistent nurturing of a culture of
              continuous learning and continual improvement in processes, tools,
              and technologies.
              <br />
              <br />
              Our objective is to create value for our clients, which can take
              any form—cost efficiency, faster time-to-market, higher quality,
              dependability, or overall relationship and satisfaction. We bring
              in all our expertise and strengths to achieve this and succeed
