...
export default function ContentTransformationPage() {
  return (
    <div className="bg-white text-black px-5 sm:px-0">
      ...
      <GridBackground>
        <h1 className="text-purple-800 mb-10 ">Content Transformation</h1>
  ...
  <div className="col-span-full md:col-span-8 flex flex-col justify-center items-center space-y-8">
    <h2 className="text-3xl md:text-4xl font-bold text-pretty mb-4">Content Transformation Services: Stay Relevant in a Competitive Market</h2>
