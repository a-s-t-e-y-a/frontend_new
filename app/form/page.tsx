...
export default function FormPage() {
  ...
  return (
    <div className="bg-white text-black">
      ...
      <div className="min-h-screen bg-gray-200 flex items-center justify-center my-10">
        <div className="flex flex-wrap lg:flex-row items-center lg:items-start gap-20 justify-center">
          ...
          <div className="lg:ml-8 mt-8 lg:mt-0 w-4/5 sm:w-1/2">
            ...
            <form className="my-8 space-y-4">
              ...
              <button type="submit" className="bg-blue-500 text-white py-2 px-4 rounded-lg w-full">Submit</button>
            </form>
          </div>
        </div>
      </div>
