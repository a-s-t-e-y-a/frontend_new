...
export default function About() {
  ...
  return (
    <div className='bg-white text-gray-600'>
      ...
      <div className="my-10 flex flex-col lg:flex-row items-center justify-between lg:px-16 lg:gap-20 space-x-2xl">
      ...
      <div className="my-10 flex flex-col lg:flex-row items-center justify-between lg:px-16 lg:gap-20 space-x-2xl">
        <div className="w-full lg:w-1/2">
          ...
          <Image src={img1} alt="why" className='w-full sm:w-[400px] aspect-square my-5 sm:my-0'/>
      </div>
