...
<div className="flex flex-col justify-center items-center ">
        ...
        <h1 className="text-purple-800 mb-5  text-3xl sm:text-6xl font-extrabold mt-5 sm:my-10">Content Transformation</h1>
        <h3 className="text-base w-full sm:w-3/4 m-auto text-gray-500 sm:text-center">Technology has been evolving continuously and so have the standards to store and exchange content. The trend has created an ever-growing need to transform content from one standard to another.</h3>
  ...
  <div className="col-span-full md:col-span-8 flex flex-col justify-center items-center space-y-8">
    <h2 className="text-xl md:text-4xl font-bold text-pretty mb-4">Content Transformation Services: Stay Relevant in a Competitive Market</h2>
